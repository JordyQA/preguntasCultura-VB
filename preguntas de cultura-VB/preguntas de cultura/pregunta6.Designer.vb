...
Partial Class pregunta6
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "conocida como «la novia del mar»?"
        '
        'lbl_Incorrecta2
        '
        ...
        Me.Label6.Text = "12.-¿Cuál es la ciudad italiana "
        '
        'lbl_Correcta2
        '
        ...
        Me.RadioButton4.Text = "C: Venecia"
        ...
        Me.RadioButton5.Text = "B: Florencia"
        ...
        Me.Label7.Text = "está en dos continentes distintos?"
        '
        'lbl_Incorrecta
        '
        ...
        Me.RadioButton1.Text = "A: Estambul"
        ...
        Me.Label3.Text = "11.-¿Cuál es la única ciudad que "
        '
        'Button2
        '
